        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromWhom = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    IsRight = table.Column<bool>(type: "bit", nullable: false),
                    IsCheked = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vocabulary", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Vocabulary_AspNetUsers_FromWhom",
                        column: x => x.FromWhom,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Vocabulary_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Vocabulary_Definitions_DefinitionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vocabulary_FromWhom",
                table: "Vocabulary",
                column: "FromWhom");

            migrationBuilder.CreateIndex(
                name: "IX_Vocabulary_OwnerId",
                table: "Vocabulary",
                column: "OwnerId");
